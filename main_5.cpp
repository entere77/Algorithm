...
int W = 52; //허용 가능 무게
bool include[N_ITEMS + 1];  // 아이템을 포함하느냐, 포함하지 않느냐 ??

int m = 2; //유망한 마디의 수, 아이템을 포함하는 경우, 포함하지않는 경우해서 총 2개.
int mprod; //현 단계까지의 유망한 마디의수의 곱
int t = 2;//모든 자식 마디의 수, 아이템을 포함하는 경우, 포함하지않는 경우해서 총 2개.
